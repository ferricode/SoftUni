...
namespace Tests
{
    public class DatabaseTests
    {
        ...
        [Test]
        public void Add_AddsElementTodDatabase()
        {
            int element = 123;
        ...
        [Test]
        public void FetcReturnsDatabaseCopyInsteadOfReference()
        {
        ...
        [Test]
        public void Count_Return_Zero_WhenDatabaseIsEmpty()
        {
            Assert.That(this.database.Count, Is.EqualTo(0));
        }
        [Test]
        public void Ctor_ThrowsException_WhenDatabaseCapacityIsEmpty()
        {
