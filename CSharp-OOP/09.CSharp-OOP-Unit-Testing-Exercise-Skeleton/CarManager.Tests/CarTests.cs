...
namespace Tests
{
    public class CarTests
    {
        ...
        [TestCase(0)]
        [TestCase(-20)]
        public void Refues_ThrowsExceptionWhenFuelIsZeroOrNegative(double fuel)
        {
        ...
        [Test]
        public void Drive_DecreasesFuelAmountToZero_WhenRequiredFuelAmountIsExactAsFuelAmount()
        {
